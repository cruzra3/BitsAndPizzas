...
public class Milestones {
    ...
    // Test removing the AppBar in order to use a Toolbar.
    // Test adding a toolbar to the application.
    ...
    // Test succesfully process to add store logic for recycler view.
}
